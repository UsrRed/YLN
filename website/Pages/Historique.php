<?php
session_start(); #Pour que seul les utilisateurs connectés accèdent à la page
...
#Récupération de l'histroique des comparaisons en fonction de l'utilisateur connecté
...
$id_utilisateur = $ligne_utilisateur['id']; #On récupère l'ID ici car le nom de la ligne ID correspond à l'ID de l'utilisateur
...
<div class="container mt-5">
    	<?php
    	#Affiche l'historque des comparaisons en fonction de l'utilisateur connecté
    	echo "<h2>Historique des comparaisons pour " . $_SESSION['utilisateur'] . " :</h2>";
	echo "<br/><br/>";
    	echo "<table class='table table-bordered'>";
    	echo "<thead><tr><th>ID</th><th>Comparaison 1</th><th>Comparaison 2</th><th>Date</th></tr></thead><tbody>";
