...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	if ($result->num_rows > 0){
		...
		$req1 = "SELECT nom_utilisateur, adresse_email, mot_de_passe_application, mot_de_passe FROM Utilisateur WHERE nom_utilisateur = '$utilisateur'";
		...
		$vrai_mdp = $par_ligne['mot_de_passe'];
