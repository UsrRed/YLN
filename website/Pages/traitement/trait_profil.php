    ...
    <div class="container mt-5">
        ...
        <form action="/trait_info_profil" method="post">
            ...
            <div class="form-group">
                ...
                <input type="email" class="form-control" id="email" name="email" placeholder="Entrez votre adresse e-mail" required pattern="[a-zA-Z0-9._%+-]+@gmail\.com$">
            </div>

            <div class="form-group">
                <label for="app_password">Mot de passe d'application :</label>
                <input type="password" class="form-control" id="app_password" name="app_password" placeholder="Entrez votre mot de passe d'application" required>
