...
<body class="bg-light">
	...
	<form action="/trait_mdp_oublie" method="post">
            ...
            <div class="form-group">
                ...
                <input type="email" class="form-control" id="email" name="email" placeholder="Entrez votre adresse e-mail" pattern="[a-z0-9._%+-]+@gmail\.com$" title="Adresse e-mail Gmail uniquement" required>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="password" class="form-control" id="motdepasse" name="motdepasse" placeholder="Entrez votre mot de passe d'application" required>
            </div>
